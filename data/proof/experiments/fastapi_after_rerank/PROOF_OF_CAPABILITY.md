...
- Mean automatic architecture/dependency/security correctness: 0.053.
...
- analysis: 65.424s total
- indexing: 34.37s total
- chroma_upsert: 32.974s total
- security: 27.235s total
- embedding: 20.48s total
- ingestion: 5.745s total
- technical_debt: 1.341s total
- parse_files: 1.191s total
